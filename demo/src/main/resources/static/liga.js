...
function verEquipos() {
    ...
    xhttp.open("GET", "http://localhost:8080/teams", true);
    xhttp.send();
}
...
function verEquipo() {
    ...
    xhttp.open("GET", "http://localhost:8080/teams/" + idEquipo, true);
    xhttp.send();
}
...
function crearEquipo() {
    ...
    xhttp.open("POST", "http://localhost:8080/teams?id=" + idEquipo + "&name=" + nombre, true);
    xhttp.send();
}
...
function modificarEquipo() {
    ...
    xhttp.open("PUT", "http://localhost:8080/teams/" + idEquipo, true);
...
function anadirJugador() {
    ...
    xhttp.open("PUT", "http://localhost:8080/teams/" + idEquipo + "/" + idJugador, true);
    xhttp.send();
}
...
function borrarEquipo() {
    ...
    xhttp.open("DELETE", "http://localhost:8080/teams/" + idEquipo, true);
    xhttp.send();
}
